...
const MODULES = ['lib/schema.js', 'lib/branding.js', 'lib/recommend.js', 'lib/match.js', 'lib/wizard-questions.js', 'lib/structured-data.js', 'lib/list-groups.js'];
...
const EXPORTS = [
  ...
  'groupByGenre', 'splitByPriceKnown',
];
