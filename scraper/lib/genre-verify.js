...
const GENRE_EVIDENCE = {
  ...
  web_marketing: [
    ...
    // ブランディングはマーケティングの一分野。「ブランド」単独は入れない
    // （アパレルや「ブランド品」にも当たり、裏付けにならないため）。
    'ブランディング', 'ブランド構築', 'ブランド戦略',
  ],
  // 「AI」単独は使わない。英単語（MAIL, TRAINING など）の一部にも当たり、
  // 掲載中のほぼ全ページが該当してしまって裏付けにならなかった。
  genai_dx: [
    '生成AI', 'ChatGPT', 'Copilot', '人工知能',
    'AI活用', 'AI人材', 'AI技術', 'AIスキル', 'AIツール', 'AIエンジニア', 'AI開発',
    'AIリテラシー', 'AI講座', 'AI研修', 'AI時代',
    'DX', '機械学習', 'ディープラーニング', 'データサイエンス',
  ...
  // 「講座」「試験」「合格」「受験」「過去問」は塾・スクールなら何であれ出るため外した
  // （中高生向けの学習塾が「資格」として通過した）。
  // 資格名そのものは、その資格の講座でなければ本文に出ないので裏付けに使える。
  // 「中小企業診断士試験の合格に向けたカリキュラム」のように、資格名だけで説明し
  // 「資格」「検定」と書かないスクールを取りこぼしていたため足した（EBA中小企業診断士スクール）。
  certification: [
    '資格', '資格取得', '資格試験', '国家資格', '検定', '検定試験', '試験対策',
    '通信教育', '免許', '認定',
    '士試験', '診断士', '簿記', '宅建', '社労士', '行政書士', '税理士', '公認会計士',
    '保育士', '介護福祉士',
  ],
};
